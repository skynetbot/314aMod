...
GO
CREATE TABLE [dbo].[314_MATCH_FIRST_NAME](
...
GO
CREATE TABLE [dbo].[314_PERSON_MATCH_FIRST_NAME](
	[Id] [int] IDENTITY(1,1) NOT NULL,
...
WHILE @cnt <= @cnt_total
BEGIN
INSERT INTO [Compliance].[dbo].[314_MATCH_FIRST_NAME]
	...
	WHERE a.Nombre LIKE '%' +
		...
		FROM [Compliance].[dbo].[Persons 2019-09-04 14555] b 
		where b.Id = @cnt) + '%' AND b.Id = @cnt
INSERT INTO [Compliance].[dbo].[314_PERSON_MATCH_FIRST_NAME]
